$(document).ready(function(e) {
    ...
    var data1 = [
        { id: '001101', subject: 'FUNDAMENTAL ENGLISH 1', grade: 'D+' },
        { id: '206113', subject: 'CAL FOR SOFTWARE TECH', grade: 'C' },
        { id: '261111', subject: 'INTERNET AND ONLINE COMMUNITY', grade: 'D+' },
        { id: '951100', subject: 'MODERN LIFE AND ANIMATION', grade: 'B+' },
        { id: '953100', subject: 'COMPUTERS AND PROGRAMMING', grade: 'A' },
        { id: '955102', subject: 'DIGITAL LITERACY', grade: 'C+' },
        { id: '955103', subject: 'PROGRAMMING LOGICAL THINKING', grade: 'B+' },
        { id: '', subject: 'Total GPA', grade: '2.53'}
    ];

    var data2 = [
        { id: '001102', subject: 'FUNDAMENTAL ENGLISH 2', grade: 'C' },
        { id: '140104', subject: 'CITIZENSHIP', grade: 'D' },
        { id: '206281', subject: 'DISCRETE MATHEMATICS', grade: 'C' },
        { id: '953102', subject: 'ADT & PROBLEM SOLVING', grade: 'C+' },
        { id: '953202', subject: 'INTRODUCTION TO SE', grade: 'C' },
        { id: '953211', subject: 'COMPUTER ORGANIZATION', grade: 'D' },
        { id: '953231', subject: 'OBJECT ORIENTED PROGRAMMING', grade: 'B' },
        { id: '', subject: 'Total GPA', grade: '1.93'}
    ];

    var data3 = [
        { id: '001201', subject: 'CRIT READ AND EFFEC WRITE', grade: 'D' },
        { id: '011269', subject: 'PHIL OF SUFFICIENCY ECON', grade: 'A' },
        { id: '208263', subject: 'ELEMENTARY STATISTICS', grade: 'W' },
        ...
        { id: '953251', subject: 'HFAC IN DIGI INTERACT DESIGN', grade: 'B+' },
        { id: '', subject: 'Total GPA', grade: '2.42'}
    ];
